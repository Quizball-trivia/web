...
export const TD = {
  ...
  dailyStart: 'დაწყება',
  dailyRulesGtg: 'ლეგენდარული გოლი დაფაზე სვლა-სვლა იხატება. რაც უფრო ადრე გამოიცნობ, მეტ ქულას მიიღებ — პასუხის შემდეგ კი რეალურ კადრებს ნახავ.',
  ...
  dailyPillGtg: 'მყისიერი პასუხი · 100 — სრული გამეორება · 40',
