        ...
        <div className="rounded-[28px] border border-white/10 bg-[#17222A]/90 p-6 shadow-[0_24px_60px_rgba(0,0,0,0.28)]">
          ...
          <div className="mt-8 flex items-center justify-between gap-3">
            ...
            <button
              ...
              className="rounded-2xl bg-[#38B60E] px-5 py-3 text-sm font-semibold text-white transition hover:bg-[#43c116] disabled:cursor-not-allowed disabled:opacity-50"
            >
