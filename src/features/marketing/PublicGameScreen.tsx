    ...
    <PublicPageFrame>
      ...
      <section className="mt-4 grid items-start gap-8 md:grid-cols-[1.2fr_1fr] md:grid-rows-[auto_1fr]">
        <div className="md:col-start-1 md:row-start-1">
          ...
          <p className="mt-3 text-sm font-semibold text-brand-yellow">{game.guest === "demo" ? (isCoinSample ? labels.coinLabel : isDaily ? labels.guestDaily : labels.guest) : home.cards.accountRequired}</p>
