  ...
  return (
    <PublicPageFrame>
      ...
      <section className="mt-12 max-w-3xl rounded-2xl border border-white/10 bg-white/[0.04] p-5">
        <h2 className="text-lg font-bold uppercase">{competitive ? labels.compete : labels.account}</h2>
        <p className="mt-2 text-sm text-white/75">{competitive ? labels.competeText : game.demoSlug?.startsWith("daily-") ? labels.accountTextDaily : labels.accountText}</p>
