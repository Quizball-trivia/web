...
export const CAMPAIGN_QUIZ_CONTENT: Record<string, CampaignQuizPageContent> = {
  liverpool: {
    ...
    description:
      'Free Liverpool quiz — 10 verified questions on the Reds. Instant score, no sign-up needed to play. Then take on real fans in ranked football duels.',
    breadcrumbLabel: 'Liverpool Quiz',
    heroLead: 'Liverpool Quiz —',
    heroHighlight: 'Test Your LFC Knowledge',
    lede:
      'Think you know the Reds? Play our free Liverpool quiz — 10 verified questions covering Anfield legends, European nights and Premier League glory. No sign-up needed: answer, get your score instantly, and see how you rank against thousands of football fans. Ready when you are — kick off below.',
  ...
  'manchester-united': {
    ...
    description:
      'Free Man United quiz — 10 verified questions on the Red Devils. Instant score, no sign-up needed to play. Then beat real fans in ranked football duels.',
    breadcrumbLabel: 'Man United Quiz',
    heroLead: 'Man United Quiz —',
    heroHighlight: 'Test Your Red Devils Knowledge',
    lede:
      'How well do you really know Manchester United? Play our free Man United quiz — 10 verified questions on Old Trafford legends, treble glory and Premier League dominance. No sign-up needed: instant score, then see how you compare with thousands of football fans. Kick off below.',
    ...
    aboutParagraphs: [
      ...
      'This Man United quiz pulls 10 verified questions from QuizBall’s football trivia bank, covering the icons — Sir Bobby Charlton, Eric Cantona, the Class of 92, Wayne Rooney’s record-breaking goals — plus the moments every United fan argues about at the pub. Every answer has been checked before it reaches you.',
  ...
  tottenham: {
    ...
    description:
      'Free Tottenham quiz — 10 verified questions on Spurs. Instant score, no sign-up needed to play. Then take on real fans in ranked football trivia duels.',
    breadcrumbLabel: 'Tottenham Quiz',
    heroLead: 'Tottenham Quiz —',
    heroHighlight: 'Test Your Spurs Knowledge',
    lede:
      'Audere est facere — to dare is to do. Dare to take our free Tottenham quiz: 10 verified questions on Spurs legends, White Hart Lane history and famous European nights. No sign-up needed — instant score, then see how you compare with thousands of football fans.',
    ...
    aboutParagraphs: [
      ...
      'Every question comes from QuizBall’s verified trivia bank, so the facts stand up to pub-argument scrutiny. You’ll get 10 questions per round across a range of difficulty levels.',
  ...
  everton: {
    ...
    description:
      'Free Everton quiz — 10 verified questions on the Toffees. Instant score, no sign-up needed to play. Then beat real fans in ranked football duels.',
    breadcrumbLabel: 'Everton Quiz',
    heroLead: 'Everton Quiz —',
    heroHighlight: 'Test Your Toffees Knowledge',
    lede:
      'Nil satis nisi optimum — nothing but the best is good enough. Prove you meet the standard with our free Everton quiz: 10 verified questions on Toffees history, Goodison legends and Merseyside derby drama. Instant score, no sign-up needed to play. Kick off below.',
  ...
  'premier-league': {
    ...
    lede:
      'Three decades of drama, one quiz. Play our free Premier League football quiz — 10 verified questions covering title races, record-breakers, great escapes and 5000-1 miracles. No sign-up needed: answer, get your score instantly, and see how your PL knowledge stacks up against thousands of fans.',
    ...
    aboutParagraphs: [
      ...
      'This premier league football quiz takes 10 verified questions per round from QuizBall’s trivia bank — records, title races, iconic goals and the pub-quiz staples every fan should know, with a few curveballs for the anoraks. Every fact is checked, so if a question costs you a point, it’ll hold up when you double-check it.',
  ...
  'guess-the-player': {
    ...
    description:
      'Play football guess who free — read the clues, guess the player in 10 rounds. Instant score, no sign-up to play. Then beat real fans in ranked duels.',
    breadcrumbLabel: 'Guess the Player',
    heroLead: 'Guess the Player —',
    heroHighlight: 'Football Guess Who',
    lede:
      'Football guess who, done properly. We give you the clues — nationality, clubs, iconic moments — you name the player. Ten rounds, verified facts, instant score, and no sign-up needed to play. Get them all and you’ve earned the right to call yourself a ball-knowledge merchant.',
  ...
  'career-path': {
    ...
    description:
      'Guess the player from their career path — free quiz, 10 verified transfer trails. Instant score, no sign-up to play. Then beat real fans in ranked duels.',
    breadcrumbLabel: 'Career Path Quiz',
    heroLead: 'Football',
    heroHighlight: 'Career Path Quiz',
    lede:
      'Club by club, transfer by transfer — can you name the player from their career path alone? Ten verified transfer trails, from academy to final destination. Free to play, instant score, no sign-up needed. The ultimate guess-the-career-path challenge for proper football anoraks.',
  ...
  'club-badges': {
    ...
    description:
      'Free football club badges quiz — guess the club from its crest. 10 verified questions, instant score, no sign-up to play. Beat real fans in duels.',
    breadcrumbLabel: 'Club Badges Quiz',
    heroLead: 'Football Club Badges Quiz —',
    heroHighlight: 'Guess the Logo',
    lede:
      'Every crest tells a story — liver birds, cockerels, cannons and towers. Our free football club badges quiz tests whether you can match the symbol to the club. Ten verified questions, instant score, no sign-up needed to play. How well do you really know your logos?',
    ...
    aboutParagraphs: [
      ...
      'This football club badges quiz asks you to match the symbol to the club: 10 verified questions per round, mixing Premier League giants with historic clubs whose crests any self-respecting fan should recognise. It’s harder than it sounds — plenty of lions, birds and castles to confuse the casuals.',
