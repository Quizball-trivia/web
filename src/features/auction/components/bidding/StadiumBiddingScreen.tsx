    ...
    >
      ...
      <div className="shrink-0 px-2 pb-[max(0.5rem,env(safe-area-inset-bottom))] pt-3 md:px-4 md:pb-4 md:pt-5">
        <motion.div
          ...
          className="mx-auto flex max-h-[46dvh] w-full max-w-lg flex-col overflow-y-auto rounded-t-[24px] border-2 border-white/15 bg-brand-blue px-3.5 pt-2.5 pb-3 shadow-[0_-8px_36px_rgba(0,0,0,0.5)] md:rounded-[24px]"
        >
