...
/** The Play screen body, shared by /play (members) and the locale hubs (guests). */
export function PlayHome({ beforeFooter }: { beforeFooter?: ReactNode } = {}) {
  ...
  // Categories and the wallet only matter for starting a match; a signed-out
  // visitor on the hub never gets there, so the guest page makes no such calls.
