            ...
            {featuredCategories.map((cat, i) => {
              ...
              return (
                ...
                >
                  ...
                  <div
                    className={`relative z-10 flex h-full items-center justify-center text-center text-sm md:text-base font-black uppercase tracking-wide leading-tight text-white transition-opacity duration-200 drop-shadow-[0_2px_14px_rgba(0,0,0,0.45)] ${
                      cat.imageUrl
