...
export const DEMO_QUESTIONS: DemoQuestion[] = [
  ...
  },
  {
    ...
    difficulty: "easy",
    category: { en: "World Cup", ka: "მსოფლიო ჩემპიონატი", es: "Copa Mundial", tr: "Dünya Kupası" },
    prompt: { en: "Which English club is famously known as \"The Invincibles\" for going undefeated during the 2003-04 Premier League season?", ka: "რომელი ინგლისური კლუბია ცნობილი როგორც „უძლეველები“ 2003-04 წლების პრემიერ ლიგის სეზონში დაუმარცხებლად ასპარეზობის გამო?", es: "¿Qué club inglés es conocido como \"Los Invencibles\" por acabar invicto la temporada 2003-04 de la Premier League?", tr: "Hangi İngiliz kulübü 2003-04 Premier Lig sezonunu yenilgisiz tamamladığı için \"Yenilmezler\" olarak bilinir?" },
    options: [
      { en: "Manchester United", ka: "მანჩესტერ იუნაიტედი", es: "Manchester United", tr: "Manchester United" },
      { en: "Chelsea", ka: "ჩელსი", es: "Chelsea", tr: "Chelsea" },
      { en: "Arsenal", ka: "არსენალი", es: "Arsenal", tr: "Arsenal" },
      { en: "Liverpool", ka: "ლივერპული", es: "Liverpool", tr: "Liverpool" },
    ],
    correctIndex: 2,
  },
  {
