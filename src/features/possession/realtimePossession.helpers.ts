...
export const GOAL_CELEBRATION_MS = 4000;
export const GOAL_RESULT_HANDOFF_MS = TRANSITION_DELAY_MS + GOAL_CELEBRATION_MS;
export const DEV_GOAL_CELEBRATION_DELAY_MS = 800;
export const DEV_ATTACK_GOAL_HOLD_MS = GOAL_CELEBRATION_MS + DEV_GOAL_CELEBRATION_DELAY_MS;
export const GOAL_SHOT_TO_CELEBRATION_MS = 1900;
export const GOAL_ATTACK_START_DELAY_MS = 1000;
export const GOAL_VISUAL_SEQUENCE_MS = GOAL_ATTACK_START_DELAY_MS + GOAL_SHOT_TO_CELEBRATION_MS + GOAL_CELEBRATION_MS;
export const GOAL_SHOT_TO_FIELD_RESET_MS = GOAL_SHOT_TO_CELEBRATION_MS + 100;
