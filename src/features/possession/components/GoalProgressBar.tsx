...
export function GoalProgressBar({
  ...
  if (orientation === 'horizontal') {
    return (
      <div className="w-full px-3 py-2">
        <div className="mb-1.5 flex items-baseline justify-between font-poppins leading-none">
  ...
  // Vertical (web): fills from the bottom (0) up to the goal (100) at the top.
  ...
  return (
    <div className="flex h-full flex-col items-center py-2">
      ...
      <div className="relative w-3 flex-1 rounded-full bg-white/10">
        {/* white goal line at the very top of the track */}
        <span className="absolute -top-px left-1/2 z-10 h-[3px] w-5 -translate-x-1/2 rounded-full bg-white" />
        <motion.div
        ...
        <motion.div
          ...
          animate={{ bottom: `calc(${score}% - 0.5rem)` }}
          transition={{ type: 'spring', stiffness: 200, damping: 26 }}
        >
