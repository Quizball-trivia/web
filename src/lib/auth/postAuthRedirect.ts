 ...
 */
const RETURNABLE_PATH = /^\/(play|leaderboard|events|auction|tic-tac-toe|friend|weekend-league|free-kicks|road-to-goal|trivia-mines|squad-spin|guess-the-goal|missing-xi|daily\/challenges\/[a-z0-9-]+|(en|ka|es|tr)(\/[a-z0-9-]+(\/[a-z0-9-]+)?)?)\/?$/;
