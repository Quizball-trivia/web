...
export const HUB_COPY: Record<HubKind, Record<Locale, HubCopy>> = {
  ...
  daily: {
    en: {
      ...
      intro: "Every day at 04:00 Georgia time a fresh set unlocks. Play them all, keep your streak, and earn coins and XP for each one.",
    ...
    ka: {
      ...
      intro: "ყოველდღე 04:00-ზე (საქართველოს დროით) ახალი ნაკრები იხსნება. ითამაშე ყველა, შეინარჩუნე სერია და დააგროვე მონეტები და XP თითოეულზე.",
    ...
    es: {
      ...
      intro: "Cada día a las 04:00 (hora de Georgia) se desbloquea un set nuevo. Juégalos todos, mantén tu racha y gana monedas y XP por cada uno.",
    ...
    tr: {
      ...
      intro: "Her gün 04:00'te (Gürcistan saati) yeni bir set açılır. Hepsini oyna, serini koru ve her biri için jeton ve XP kazan.",
