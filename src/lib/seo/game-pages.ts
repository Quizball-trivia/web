...
export const PUBLIC_GAMES_FOLDER: Record<Locale, string> = { en: "football-games", ka: "football-games", es: "juegos-de-futbol" };
export const DAILY_COLLECTION_SLUG: Record<Locale, string> = { en: "daily-challenges", ka: "daily-challenges", es: "retos-diarios" };
...
const cta = { en: "Play now", ka: "ითამაშე ახლავე", es: "Jugar ahora" } as const;
