...
export const HOME_COPY: Record<Locale, HomeCopy> = {
  en: {
    ...
    intro: "Play football trivia games in your browser. Try Football Tic Tac Toe, build a team in Football Auction, or challenge a friend without creating an account. Ready to compete? Sign up for Ranked play and Weekend League, where eligible players can compete for real voucher prizes under the competition rules.",
  ...
  es: {
    ...
    intro: "Juega a juegos de trivia de fútbol en tu navegador. Prueba Tiki Taka Toe, forma un equipo en la subasta o reta a un amigo sin crear cuenta. ¿Listo para competir? Regístrate para el modo clasificatorio y la Weekend League, donde los jugadores elegibles compiten por premios en vales según las reglas de cada competición.",
  ...
  ka: {
    ...
    intro: "ითამაშე საფეხბურთო ტრივია ბრაუზერში. სცადე საფეხბურთო იქს-ნული, ააწყვე გუნდი აუქციონზე ან გამოიწვიე მეგობარი ანგარიშის გარეშე. მზად ხარ შეჯიბრისთვის? დარეგისტრირდი რეიტინგული თამაშისა და შაბათ-კვირის ლიგისთვის, სადაც უფლებამოსილი მოთამაშეები კონკურსის წესებით ვაუჩერებზე იბრძვიან.",
