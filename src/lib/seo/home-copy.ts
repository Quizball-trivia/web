...
export const COLLECTION_COPY: Record<SeoPageLocale, { metaTitle: string; metaDescription: string; h1: string; intro: string; reset: string }> = {
  ...
  tr: { metaTitle: "Günlük Futbol Görevleri — Her Gün Yeni Bir Set | QuizBall", metaDescription: "Quizball'un günlük futbol görevleri: Money Drop, Doğru mu Yanlış mı, Countdown, Daha mı Az mı, Köstebek ve Kart Dedektifi. Misafir olarak alıştır, gerçeğini uygulamada oyna.", h1: "Günlük futbol görevleri", intro: "Her gün her tür için yeni bir set. Burada misafir olarak alıştırma turu oyna; gerçek set, jetonlar ve seri için uygulamaya giriş yap.", reset: "Setler her gün gece yarısı (UTC) yenilenir." },
};
