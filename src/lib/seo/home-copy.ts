...
export const HOME_COPY: Record<Locale, HomeCopy> = {
  en: {
    ...
    intro: "Play football trivia games in your browser. Try a practice round of Football Tic Tac Toe or Football Auction without creating an account. Ranked play and Weekend League need a Quizball account. Ready to compete? Sign up for Ranked play and Weekend League, where eligible players can compete for real prizes under the competition rules.",
    ...
    whyAccount: [
      ...
      "Build your rank, follow the standings and compete for the prizes available under each competition's rules. Check the current eligibility, schedule and prize details before entering.",
    ...
    faq: [
      ...
      { q: "Can I win real prizes?", a: "Eligible players can compete for prizes in the competitions that offer them. Read the current Ranked and Weekend League rules for the available prizes and how to qualify." },
      { q: "Do mini-game scores count toward Ranked play?", a: "Guest mini-game results do not award Ranked points or qualify you for prizes. Ranked progression follows the competitive mode's own rules." },
  ...
  es: {
    ...
    cards: { practice: "Ronda de práctica", accountRequired: "Requiere cuenta", guest: "Jugar como invitado", playLabel: "Jugar", rankedTitle: "Modo clasificatorio", rankedText: "Pon a prueba tu fútbol contra otros jugadores y construye tu rango. Requiere cuenta.", rankedCta: "Regístrate para clasificatorio", wlTitle: "Weekend League", wlText: "Entra en la competición de fin de semana de Quizball y compite por los premios disponibles. Requiere cuenta; se aplican reglas de elegibilidad y del evento.", wlCta: "Ver detalles de la Weekend League", quizPage: "Abrir el quiz" },
    whyAccount: [
      ...
      "Construye tu rango, sigue la clasificación y compite por los premios disponibles según las reglas de cada competición. Consulta la elegibilidad, el calendario y los premios vigentes antes de participar.",
    ...
    faq: [
      ...
      { q: "¿Puedo ganar premios reales?", a: "Los jugadores elegibles compiten por premios en las competiciones que los ofrecen. Lee las reglas vigentes del clasificatorio y de la Weekend League para conocer los premios y cómo clasificarte." },
      { q: "¿Los minijuegos cuentan para el clasificatorio?", a: "Los resultados de invitado no dan puntos de clasificación ni acceso a premios. La progresión clasificatoria sigue sus propias reglas." },
  ...
  ka: {
    ...
    cards: { practice: "სავარჯიშო რაუნდი", accountRequired: "ანგარიშია საჭირო", guest: "ითამაშე სტუმრად", playLabel: "თამაში", rankedTitle: "რეიტინგული თამაში", rankedText: "შეამოწმე ცოდნა სხვა მოთამაშეების წინააღმდეგ და აიწიე რეიტინგში. ანგარიშია საჭირო.", rankedCta: "დარეგისტრირდი რეიტინგულისთვის", wlTitle: "შაბათ-კვირის ლიგა", wlText: "შეუერთდი Quizball-ის შაბათ-კვირის შეჯიბრს და იბრძოლე ხელმისაწვდომი პრიზებისთვის. ანგარიშია საჭირო; მოქმედებს უფლებამოსილებისა და ტურნირის წესები.", wlCta: "ლიგის დეტალები", quizPage: "ქვიზის გახსნა" },
    whyAccount: [
      "სტუმრის თამაშები Quizball-ს მაშინვე გაცნობს. შექმენი ანგარიში, როცა რეიტინგულ თამაშსა და შაბათ-კვირის ლიგაში შეჯიბრი გინდა.",
      "აიწიე რეიტინგში, ადევნე თვალი ცხრილს და იბრძოლე პრიზებისთვის თითოეული კონკურსის წესებით. მონაწილეობამდე გადაამოწმე უფლებამოსილება, განრიგი და პრიზები.",
    ...
    faq: [
      ...
      { q: "შემიძლია ნამდვილი პრიზების მოგება?", a: "უფლებამოსილი მოთამაშეები პრიზებზე იბრძვიან იმ შეჯიბრებში, სადაც ისინი გათვალისწინებულია. წაიკითხე რეიტინგული და შაბათ-კვირის ლიგის მოქმედი წესები პრიზებისა და კვალიფიკაციის შესახებ." },
      { q: "ითვლება მინი-თამაშების ქულები რეიტინგულში?", a: "სტუმრის შედეგები რეიტინგულ ქულებს ან პრიზებზე უფლებას არ იძლევა. რეიტინგული პროგრესი თავისი წესებით მიდის." },
  ...
  tr: {
    ...
    cards: { practice: "Alıştırma turu", accountRequired: "Hesap gerekir", guest: "Misafir olarak oyna", playLabel: "Oyna", rankedTitle: "Sıralamalı Oyun", rankedText: "Futbol bilgini diğer oyunculara karşı sına ve sıralamanı yükselt. Hesap gerekir.", rankedCta: "Sıralamalı için kaydol", wlTitle: "Hafta Sonu Ligi", wlText: "Quizball'un hafta sonu yarışmasına katıl ve mevcut ödüller için yarış. Hesap gerekir; uygunluk ve etkinlik kuralları geçerlidir.", wlCta: "Hafta Sonu Ligi ayrıntıları", quizPage: "Quizi aç" },
    whyAccount: [
