...
export const HAIR_PARTS: AvatarPart[] = [
  ...
  ...([{
    ...
    storePosition: { top: -8, left: 22.25, width: 51.75 },
  }]),
  {
    id: "hair_boy_basic",
    slot: "hair",
  ...
  },
  {
    ...
    slot: "hair",
    name: "Girl Basic",
    asset: "/assets/store/hair_girl_basic.webp?v=2",
    priceCoins: 5000,
  ...
  },
  {
    ...
    slot: "hair",
    name: "CR7",
    asset: "/assets/store/hair_ronaldo_goat.webp?v=2",
    priceCoins: 30000,
  ...
  },
  {
    ...
    slot: "hair",
    name: "Curly Crop",
    asset: "/assets/store/hair_curly_crop.webp?v=2",
    priceCoins: 20000,
  ...
  },
  {
    ...
    slot: "hair",
    name: "Cornrows",
    asset: "/assets/store/hair_cornrows.webp?v=2",
    priceCoins: 20000,
  ...
  },
  {
    ...
    slot: "hair",
    name: "Side Part",
    asset: "/assets/store/hair_side_part.webp?v=2",
    priceCoins: 20000,
  ...
  },
  {
    ...
    slot: "hair",
    name: "Leopard",
    asset: "/assets/store/hair_leopard.webp?v=2",
    priceCoins: 20000,
...
export const GLASSES_PARTS: AvatarPart[] = [
  ...
  }]),
  {
    ...
    slot: "glasses",
    name: "Wayfarer",
    asset: "/assets/store/accessory_glasses_wayfarer.webp?v=2",
    priceCoins: 10000,
  ...
  },
  {
    ...
    slot: "glasses",
    name: "Round Shades",
    asset: "/assets/store/accessory_glasses_round.webp?v=2",
    priceCoins: 15000,
  ...
  },
  {
    ...
    slot: "glasses",
    name: "Aviator",
    asset: "/assets/store/accessory_glasses_aviator.webp?v=2",
    priceCoins: 20000,
...
export const FACIAL_HAIR_PARTS: AvatarPart[] = [
  ...COLLECTION_PARTS.filter(p => p.slot === "facialHair"),
  {
    ...
    slot: "facialHair",
    name: "Mustache",
    asset: "/assets/store/accessory_stache.webp?v=2",
    priceCoins: 10000,
  ...
  },
  {
    ...
    slot: "facialHair",
    name: "Beard",
    asset: "/assets/store/accessory_beard.webp?v=2",
    priceCoins: 15000,
  ...
  },
  {
    ...
    slot: "facialHair",
    name: "Handlebar",
    asset: "/assets/store/accessory_handlebar.webp?v=2",
    priceCoins: 15000,
  ...
  },
  {
    ...
    slot: "facialHair",
    name: "Stache & Goatee",
    asset: "/assets/store/accessory_stache_goatee.webp?v=2",
    priceCoins: 15000,
...
export const JERSEY_COLOR_PARTS: AvatarPart[] = [
  {
    ...
    slot: "jersey",
    name: "Green",
    asset: "/assets/store/jersey_green.webp?v=2",
    free: true,
  ...
  },
  {
    ...
    slot: "jersey",
    name: "Blue",
    asset: "/assets/store/jersey_blue.webp?v=2",
    free: true,
    position: JERSEY_ANCHOR,
  },
  {
    ...
    slot: "jersey",
    name: "Yellow",
    asset: "/assets/store/jersey_yellow.webp?v=2",
    free: true,
    position: JERSEY_ANCHOR,
  },
  {
    ...
    slot: "jersey",
    name: "Red",
    asset: "/assets/store/jersey_red.webp?v=2",
    free: true,
    position: JERSEY_ANCHOR,
  },
  {
    ...
    slot: "jersey",
    name: "Violet",
    asset: "/assets/store/jersey_violet.webp?v=2",
    free: true,
    position: JERSEY_ANCHOR,
  },
  {
    ...
    slot: "jersey",
    name: "Pink",
    asset: "/assets/store/jersey_pink.webp?v=2",
    free: true,
    position: JERSEY_ANCHOR,
  },
];
...
export const JERSEY_DESIGN_PARTS: AvatarPart[] = [
  ...
  },
  {
    ...
    slot: "jersey",
    name: "Barcelona",
    asset: "/assets/store/jersey_barcelona.webp?v=2",
    priceCoins: 30000,
  ...
  },
  {
    ...
    slot: "jersey",
    name: "Milan",
    asset: "/assets/store/jersey_milan.webp?v=2",
    priceCoins: 30000,
  ...
  },
  {
    ...
    slot: "jersey",
    name: "Liverpool",
    asset: "/assets/store/jersey_liverpool.webp?v=2",
    priceCoins: 30000,
  ...
  },
  {
    ...
    slot: "jersey",
    name: "Bayern",
    asset: "/assets/store/jersey_bayern.webp?v=2",
    priceCoins: 30000,
  ...
  },
  {
    ...
    slot: "jersey",
    name: "PSG",
    asset: "/assets/store/jersey_psg_retro.webp?v=2",
    priceCoins: 50000,
  ...
  },
  {
    ...
    asset: "/assets/store/jersey_argentina_retro.webp?v=2",
    priceCoins: 30000,
  ...
  },
  {
    ...
    slot: "jersey",
    name: "Brazil Retro",
    asset: "/assets/store/jersey_brazil_retro.webp?v=2",
    priceCoins: 30000,
  ...
  },
  {
    ...
    slot: "jersey",
    name: "France Retro",
    asset: "/assets/store/jersey_france_retro.webp?v=2",
    priceCoins: 30000,
  ...
  },
  {
    ...
    slot: "jersey",
    name: "Germany Retro",
    asset: "/assets/store/jersey_germany_retro.webp?v=2",
    priceCoins: 30000,
  ...
  },
  {
    ...
    asset: "/assets/store/jersey_netherlands_retro.webp?v=2",
    priceCoins: 30000,
