...
export const tierConfig: Record<TierName, TierVisual> = {
  ...
  'Reserve':        { emoji: '🛡️', color: 'text-zinc-300',    gradient: 'from-zinc-500 to-zinc-400',     glow: 'shadow-zinc-400/40' },
  ...
  'Captain':        { emoji: '💪', color: 'text-orange-300',  gradient: 'from-orange-500 to-orange-400', glow: 'shadow-orange-400/40' },
